  ...
  <div>
            ...
            <ul class="cart-item-list">
              <li v-for="(item,key) in cartList" :key="key">
                ...
                <div class="cart-tab-4">
                  ...
                  >{{(item.productNum * item.salePrice) | currency('$')}}</div>
                </div>
    ...
    <Modal :mdShow="modalConfirm" @close="closeModal">
      ...
      <div class="btn_main" slot="btnGroup">
        <a class="btn btn--m" id="btn_off" @click="delCart" href="javascript:;">确认</a>
        <a class="btn btn--m" id="btn_off" @click="modalConfirm = false" href="javascript:;">关闭</a>
      </div>
    </Modal>
    <NavFooter></NavFooter>
  </div>
